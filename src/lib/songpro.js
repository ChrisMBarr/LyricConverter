...
SongPro.SECTION_REGEX = /#\s*([^$]*)/;
SongPro.ATTRIBUTE_REGEX = /@(\w*)=([^%]*)/;
SongPro.CUSTOM_ATTRIBUTE_REGEX = /!(\w*)=([^%]*)/;
SongPro.CHORDS_AND_LYRICS_REGEX = /(\[[\w#b/]+])?([\w\s',.!()_\-"]*)/gi;
SongPro.MEASURES_REGEX = /([[\w#b/\]+\]\s]+)[|]*/gi;
SongPro.CHORDS_REGEX = /\[([\w#b+/]+)]?/gi;
SongPro.COMMENT_REGEX = />\s*([^$]*)/;
if (typeof exports !== "undefined") {
